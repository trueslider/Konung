...
public class KonungBlockWoodBench extends BlockContainer
{
        private Class BenchEntityClass;
        
        public KonungBlockWoodBench(int i, Class class1)
        {
        ...
        {
                return mod_konungFurniture.itemWoodBench.shiftedIndex;
        }
        //Количество дропа
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new KonungTileEntityWoodBench();
	}
