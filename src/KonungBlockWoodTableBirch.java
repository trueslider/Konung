...
public class KonungBlockWoodTableBirch extends BlockContainer
{
        private Class TableEntityClass;
        public KonungBlockWoodTableBirch(int i, Class class1)
        {
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new KonungTileEntityWoodTableBirch();
	}
}