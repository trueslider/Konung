...
public class RenderKonungWoodTable extends TileEntitySpecialRenderer {
	private ModelKonungWoodTable model;

	public RenderKonungWoodTable() {
		model = new ModelKonungWoodTable();
	}

	public void renderAModelAt(TileEntityKonungWoodTable tile, double d, double d1, double d2, float f)
	{
	...
	{
		renderAModelAt((TileEntityKonungWoodTable) tileentity, d, d1, d2, f);
	}
}
