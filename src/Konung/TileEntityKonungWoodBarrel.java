...
public class TileEntityKonungWoodBarrel extends TileEntity implements IInventory
{
        ...
        public TileEntityKonungWoodBarrel adjacentChestZNeg;

        /** contains the chest tile located adjacent to this one (if any) */
        public TileEntityKonungWoodBarrel adjacentChestXPos;

        /** contains the chest tile located adjacent to this one (if any) */
        public TileEntityKonungWoodBarrel adjacentChestXNeg;

        /** contains the chest tile located adjacent to this one (if any) */
        public TileEntityKonungWoodBarrel adjacentChestZPos;
        ...
        public TileEntityKonungWoodBarrel()
        {
            barrelContents = new ItemStack[36];
        ...
        public ItemStack decrStackSize(int par1, int par2)
        {
            if (barrelContents[par1] != null)
            {
                ...
                ItemStack itemstack1 = barrelContents[par1].splitStack(par2);

                if (barrelContents[par1].stackSize == 0)
                {
                    barrelContents[par1] = null;
                }
        ...
        public void readFromNBT(NBTTagCompound par1NBTTagCompound)
        {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); i++)
            {
                ...
                {
                    barrelContents[j] = ItemStack.loadItemStackFromNBT(nbttagcompound);
                }
            }
        }
        ...
        /*public void checkForAdjacentChests()
        {
            ...
            if (worldObj.getBlockId(xCoord - 1, yCoord, zCoord) == mod_konungFurniture.woodBarrel.blockID)
            {
                adjacentChestXNeg = (TileEntityKonungWoodBarrel)worldObj.getBlockTileEntity(xCoord - 1, yCoord, zCoord);
            }

            if (worldObj.getBlockId(xCoord + 1, yCoord, zCoord) == mod_konungFurniture.woodBarrel.blockID)
            {
                adjacentChestXPos = (TileEntityKonungWoodBarrel)worldObj.getBlockTileEntity(xCoord + 1, yCoord, zCoord);
            }

            if (worldObj.getBlockId(xCoord, yCoord, zCoord - 1) == mod_konungFurniture.woodBarrel.blockID)
            {
                adjacentChestZNeg = (TileEntityKonungWoodBarrel)worldObj.getBlockTileEntity(xCoord, yCoord, zCoord - 1);
            }

            if (worldObj.getBlockId(xCoord, yCoord, zCoord + 1) == mod_konungFurniture.woodBarrel.blockID)
            {
                adjacentChestZPos = (TileEntityKonungWoodBarrel)worldObj.getBlockTileEntity(xCoord, yCoord, zCoord + 1);
            }
