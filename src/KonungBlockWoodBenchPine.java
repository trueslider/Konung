...
public class KonungBlockWoodBenchPine extends BlockContainer
{
        private Class BenchEntityClass;
        public KonungBlockWoodBenchPine(int i, Class class1)
        {
		...
		public TileEntity createNewTileEntity(World var1) {
			...
			return new KonungTileEntityWoodBenchPine();
		}
}