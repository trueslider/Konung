...
public class KonungBlockWoodTablePine extends BlockContainer
{
        private Class TablePineEntityClass;
        public KonungBlockWoodTablePine(int i, Class class1)
        {
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new KonungTileEntityWoodTablePine();
	}
}