...
public class KonungBlockWoodTableJungle extends BlockContainer
{
        private Class TableEntityClass;
        public KonungBlockWoodTableJungle(int i, Class class1)
        {
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new KonungTileEntityWoodTableJungle();
	}
}