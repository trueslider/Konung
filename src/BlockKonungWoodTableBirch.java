...
public class BlockKonungWoodTableBirch extends BlockContainer
{
        private Class TableEntityClass;
        public BlockKonungWoodTableBirch(int i, Class class1)
        {
        ...
        {
                return mod_konungFurniture.itemWoodTableBirch.shiftedIndex;
        }
        //Количество дропа
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new TileEntityKonungWoodTableBirch();
	}
}