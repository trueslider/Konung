...
public class KonungBlockWoodBenchJungle extends BlockContainer
{
        private Class BenchEntityClass;
        public KonungBlockWoodBenchJungle(int i, Class class1)
        {
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new KonungTileEntityWoodBenchJungle();
	}
}