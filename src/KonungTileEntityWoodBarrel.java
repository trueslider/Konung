...
public class KonungTileEntityWoodBarrel extends TileEntity implements IInventory
{
        ...
        public KonungTileEntityWoodBarrel adjacentChestZNeg;

        /** contains the chest tile located adjacent to this one (if any) */
        public KonungTileEntityWoodBarrel adjacentChestXPos;

        /** contains the chest tile located adjacent to this one (if any) */
        public KonungTileEntityWoodBarrel adjacentChestXNeg;

        /** contains the chest tile located adjacent to this one (if any) */
        public KonungTileEntityWoodBarrel adjacentChestZPos;
        ...
        public KonungTileEntityWoodBarrel()
        {
