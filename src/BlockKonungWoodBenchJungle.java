...
public class BlockKonungWoodBenchJungle extends BlockContainer
{
        private Class BenchEntityClass;
        public BlockKonungWoodBenchJungle(int i, Class class1)
        {
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new TileEntityKonungWoodBenchJungle();
	}
}